...
import (
	...
	mcpdriver "github.com/alexandremahdhaoui/forge-cu/internal/driver/mcp"
...
func runMCPServer(
	...
	return func() error {
		server := mcpserver.New("forge-cu", Version)
		mcpdriver.RegisterTools(server, compoSvc, commitSvc, goEngine)
